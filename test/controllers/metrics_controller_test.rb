...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post metrics_url, params: { metric: { share_count: @metric.share_count, view_count: @metric.view_count } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { share_count: @metric.share_count, view_count: @metric.view_count } }
